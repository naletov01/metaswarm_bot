...
MENUS = {
    ...
    CB_GENERATION: {
        "text": (
            ...
            "🎬 <b>Kling Standart:</b>\n\nБыстрая и доступная модель для базовой генерации видео. Подходит для тестов и простых идей.(стоимость COST_KLING_STD кредитов)\n\n"
            "🎥 <b>Kling Pro:</b>\n\nУлучшенная версия с более высокой детализацией и качеством. Отличный баланс скорости и реализма.(стоимость COST_KLING_PRO кредитов)\n\n"
            "🏆 <b>Kling Master:</b>\n\nМаксимальное качество и кинематографичность. Для тех, кто хочет получить лучшее видео из своих фото.(стоимость COST_KLING_MAST кредитов)\n\n"
            "🔥 <b>Veo3:</b>\n\nМодель от Google для генерации видео с озвучкой по текстовому описанию. Создаёт яркие и креативные ролики без загрузки фото.(стоимость COST_VEO кредитов)\n\n"
            "Выберите модель:"
        ),
